...
class FTPWrapper
{
    ...
    {
        // local file path is the where we want to download the file to.
        // remote file path is where we want to download the file from
        // Local file: 5_letter_auctions.xml.zip, Remote file: /home3/kdavies/public_html/premiumwebtechnologies.com/projects/expireddomainscraper/api/godaddy/uploads/5_letter_auctions.xml.zip
